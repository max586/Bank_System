...
import src.AuthenticationAndRegistration.CreatedAccountAndCardNumberScreen;
...
public class ChangeDataScreen extends Screen{
    ...
    public ChangeDataScreen(){}
    public ChangeDataScreen(User user, Screen prev_screen, Screen next_screen){
        ...
        submitButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                if(fname_is_valid&&lname_is_valid&&phone_nr_is_valid&&city_is_valid&&post_code_is_valid&&street_is_valid&&street_nr_is_valid&&pesel_is_valid){
                    ...
                    Database.setUserData( user.username, user.firstName, user.lastName, user.sex, user.phone_number,user.city,user.post_code,user.street, user.street_nr, user.pesel);

                    frame.dispose();
                    if(next_screen!=null){
                        frame.dispose();
                        if(next_screen!=null){
                            new SettingsMainScreen(user,ChangeDataScreen.this,new Screen()).CreateScreen();
                        }
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        new src.AuthenticationAndRegistration.RegistrationScreen2(user,null,new Screen()).CreateScreen();
    }
